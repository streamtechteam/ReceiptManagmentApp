...
var rules = {
    ...
    "no-duplicate-definitions": rule2,
    "no-duplicate-headings": rule3,
    "no-empty-definitions": rule4,
    "no-empty-images": rule5,
    "no-empty-links": rule6,
    "no-html": rule7,
    "no-invalid-label-refs": rule8,
    "no-missing-atx-heading-space": rule9,
    "no-missing-label-refs": rule10,
    "no-multiple-h1": rule11,
    "require-alt-text": rule12,
    "table-column-count": rule13,
};
